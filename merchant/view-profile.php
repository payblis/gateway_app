          ...
          <div class="pb-24 ms-16 mb-24 me-16 mt--100">
            ...
            <div class="mt-24">
              ...
              <ul>
                ...
                <li class="d-flex align-items-center gap-1 mb-12">
                  <span class="w-30 text-md fw-semibold text-primary-light">API Key :</span>
                  <span class="w-70 text-secondary-light fw-medium"><?php echo $api_key ?></span>
                </li>
                ...
                <li class="d-flex align-items-center gap-1 mb-12">
                  <a href="./resetApi.php" onclick="return confirm('Do you want to reset your API Key')" class="btn btn-danger">Reset API Key</a>
                </li>
              </ul>
            </div>
          </div>
